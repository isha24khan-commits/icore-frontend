...
/**
 * Static assets used across hero and showcase sections
 */
 ...
 * Displays hero, features, showcase section, and CTA
 */
const HomePage = () => {

  /**
   * Feature cards used in the “Everything You Need” section
   * Each feature links to a main category page
   */
  const features = [
    {
  ...
  return (
    <div className="min-h-screen" data-testid="home-page">
      ...
      {/* Hero Section - main landing introduction */}
      ...
      {/* Features Section - category navigation cards */}
      ...
      {/* Showcase Section - promotional content */}

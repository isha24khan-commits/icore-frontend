...
const LoginPage = () => {
  ...
  // UI state for error handling and loading state
   ...
   * - Calls login API via context
   * - Redirects user on success
   * - Displays formatted error on failure
   */
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-purple-50 flex items-center justify-center py-12 px-4"
    ...
    >
      ...
      <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgb(0,0,0,0.08)] p-8 sm:p-12 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="font-fredoka text-3xl text-slate-900 mb-2">
            Welcome Back!
          </h1>
        ...
        {error && (
          <div
            className="bg-red-50 text-red-600 rounded-2xl p-4 mb-6 font-nunito text-sm"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Email Input */}
          <div>
            <label className="block font-nunito font-semibold text-slate-700 mb-2">
              Email
            </label>

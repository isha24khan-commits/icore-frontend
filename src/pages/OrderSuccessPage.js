...
/**
 * OrderSuccessPage
 * Displays confirmation screen after a successful payment.
 * Shows order ID (if available) and next steps for the user.
 */
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12">
      <div className="max-w-md mx-auto px-4 text-center">
        ...
        <div className="bg-white rounded-3xl p-12 shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
          ...
          {/* Order ID display (only if available from route params) */}
          {orderId && (
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Navigate to user profile / order tracking */}
            <button

...
const VenuesPage = () => {
  // State: stores all venues from API
  ...
  useEffect(() => {
    const fetchVenues = async () => {
      try {
        ...
        setVenues(res.data); // store API response
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="font-fredoka text-4xl sm:text-5xl text-slate-900 mb-4">
            Amazing <span className="gradient-text">Venues</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {venues.map((venue) => (
            <div
              ...
              // Navigate to venue detail page on click
            ...
            >
              ...
              <div className="h-48 bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center overflow-hidden">
                ...
                {/* Handle both backend field naming styles */}
              ...
              <div className="p-6">
                ...
                {/* External Vendor Link (if exists) */}
                {venue.vendor_link && (
                  <a
